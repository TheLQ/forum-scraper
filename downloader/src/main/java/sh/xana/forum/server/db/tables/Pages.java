...
public class Pages extends TableImpl<PagesRecord> {
  ...
  /** The column <code>forum-scrape.Pages.pageId</code>. */
  public final TableField<PagesRecord, UUID> PAGEID =
      createField(
          DSL.name("pageId"),
  ...
  /** The column <code>forum-scrape.Pages.pageUrl</code>. */
  ...
  /** The column <code>forum-scrape.Pages.pageUpdated</code>. */
