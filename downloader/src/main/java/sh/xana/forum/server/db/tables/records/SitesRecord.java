...
public class SitesRecord extends UpdatableRecordImpl<SitesRecord>
    implements Record3<UUID, URI, LocalDateTime> {
  ...
  @Override
  public Row3<UUID, URI, LocalDateTime> valuesRow() {
  ...
  @Override
  public SitesRecord values(UUID value1, URI value2, LocalDateTime value3) {
    value1(value1);
    value2(value2);
    value3(value3);
    return this;
  ...
  public SitesRecord(UUID id, URI url, LocalDateTime updated) {
    super(Sites.SITES);
