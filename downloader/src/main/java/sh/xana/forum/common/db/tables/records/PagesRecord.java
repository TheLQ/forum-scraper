...
public class PagesRecord extends UpdatableRecordImpl<PagesRecord>
    implements Record8<byte[], byte[], byte[], String, String, String, LocalDateTime, String> {
  ...
  @Override
  public Row8<byte[], byte[], byte[], String, String, String, LocalDateTime, String> valuesRow() {
